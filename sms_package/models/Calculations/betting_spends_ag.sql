...
SELECT user_id,
       max(all_transactions.amount) max_betting_spend_amount,
	   min(all_transactions.amount) min_betting_spend_amount,
	   sum(all_transactions.amount) total_betting_spend_amount,
	   count(transaction_code) num_betting_spends,
 	   agg_trans.avg_daily_trans avg_daily_betting_s_transactions,
	   agg_trans.avg_daily_amount avg_daily_betting_s_amount,
	   agg_trans.avg_weekly_trans avg_weekly_betting_s_transactions,
	   agg_trans.avg_weekly_amount avg_weekly_betting_s_amount,
	   agg_trans.avg_monthly_trans avg_monthly_betting_s_transactions,
	   agg_trans.avg_monthly_amount avg_monthly_betting_s_amount
FROM all_transactions
