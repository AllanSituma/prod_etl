...
SELECT user_id,
       max(all_transactions.amount) max_send_to_bank,
	   min(all_transactions.amount) min_send_to_bank,
	   sum(all_transactions.amount) total_send_to_bank,
	   count(transaction_code) num_bank_send_transactions,
 	   agg_trans.avg_daily_trans avg_daily_bank_send_transactions,
	   agg_trans.avg_daily_amount avg_daily_bank_send_amount,
	   agg_trans.avg_weekly_trans avg_weekly_bank_send_transactions,
	   agg_trans.avg_weekly_amount avg_weekly_bank_send_amount,
	   agg_trans.avg_monthly_trans avg_monthly_bank_send_transactions,
	   agg_trans.avg_monthly_amount avg_monthly_bank_send_amount
FROM all_transactions
